...
[![GitHub Tests Action Status](https://github.com/spatie/package-laravel-tailor-laravel/actions/workflows/run-tests.yml/badge.svg)](https://github.com/oneleggedswede/laravel-tailor/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://github.com/spatie/package-laravel-tailor-laravel/actions/workflows/fix-php-code-style-issues.yml/badge.svg)](https://github.com/oneleggedswede/laravel-tailor/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
```bash
composer require oneleggedswede/laravel-tailor
```
